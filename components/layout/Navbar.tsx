  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20" role="navigation" aria-label="Main navigation">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Language Switcher */}
            <div className="relative" role="region" aria-label="Language selection">
              <button
              ...
              >
                <span className="text-base">{currentLocale === 'fr' ? '🇫🇷' : currentLocale === 'en' ? '🇺🇸' : '🇮🇱'}</span>
                ...
                {activeDropdown === 'lang' && (
                  ...
                  >
                    {supportedLocales.map((localeOption) => (
                      <Link
                        key={localeOption}
                        href={getLocalizedPath(pathname.replace(`/${currentLocale}`, '') || '/', localeOption)}
                        ...
                        className={`flex items-center space-x-2 px-4 py-2 text-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200 ${
                          localeOption === currentLocale ? 'text-primary-600 dark:text-primary-400 font-medium' : 'text-gray-700 dark:text-gray-300'
                        }`}
                        data-testid={`lang-option-${localeOption}`}
                      >
