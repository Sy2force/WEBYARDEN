        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProjects.map((project, index) => (
              <div 
                key={project.key} 
                className={`group bg-white/70 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 ${
              ...
              >
                ...
                <div className="p-6 bg-white/80 backdrop-blur-sm">
                  ...
                  <div className="bg-white/60 backdrop-blur-lg rounded-xl p-4 mb-4 border border-white/30">
