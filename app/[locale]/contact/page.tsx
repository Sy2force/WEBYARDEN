            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">{t('contact.info.phoneLabel')}</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">{t('contact.info.locationLabel')}</h3>
                    <p className="mt-1 text-gray-600">{t('contact.info.address')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">{t('contact.info.hoursLabel')}</h3>
                    <p className="mt-1 text-gray-600">{t('contact.info.hours')}</p>
                  </div>
                </div>
              </div>

              <div className="mt-8">
                <h3 className="text-lg font-medium text-gray-900 mb-4">{t('contact.social.title')}</h3>
